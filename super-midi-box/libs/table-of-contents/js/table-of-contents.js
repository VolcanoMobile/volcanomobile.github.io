			...
			$(":header").each(
				function(){
					...
					if ( titleLevel > 1  &&  titleLevel < 4 ){
						...
						//
						var referenceListItem = $('<li></li>').appendTo( referencesTable );
						
						/////
						var referenceLink = $('<a></a>').appendTo( referenceListItem );
						referenceLink.attr( 'href', '#' + anchorName );
						...
						referenceLink.addClass( 'tuto-references-table-reference ' + itemCssClass );

						/////
						var referenceText = $('<span></span>').appendTo( referenceLink );
