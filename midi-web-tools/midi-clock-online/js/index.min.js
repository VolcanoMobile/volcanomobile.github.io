...
$("#divisionSelect").val(a.division)},onStartTempo:function(){jQuery("#buttonStart").css("display","none");
jQuery("#buttonContinue").css("display","none");jQuery("#buttonStop").css("display","")
...
jQuery("#buttonStart").css("display","none");jQuery("#buttonContinue").css("display","none");
jQuery("#buttonStop").css("display","")},onContinue:function(){myMidiAccessApi.send({receivedTime:window.performance.now(),data:[251]});
jQuery("#buttonStart").css("display","none");jQuery("#buttonContinue").css("display","none");
jQuery("#buttonStop").css("display","")},onStop:function(){myMidiAccessApi.send({receivedTime:window.performance.now(),data:[252]});
jQuery("#buttonStart").css("display","");jQuery("#buttonContinue").css("display","");
jQuery("#buttonStop").css("display","none")},onClock:function(b){$("#patternClockCounter").html(b.patternClockCpt+"/"+b.patternLenghtInTick);
