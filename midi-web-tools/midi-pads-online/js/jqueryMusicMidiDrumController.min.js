...
this.refreshPadsState()};this.construct(e)};var jqueryMusicMidiDrumController=function(b){this.vars={maxRows:8,maxColumns:16,pads:null,rows:5,columns:6,callbackValuesChanged:null};
...
this.vars.pads[f][d].fixDeserialize()}}}};this.construct(b)};var jqueryMusicMidiDrumControllerPad=function(b){this.vars={events:[],changed:null};
